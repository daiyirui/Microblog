...
<table border="0" align="center" cellpadding="0" cellspacing="0" id="container">
  <tr>
    ...
    <form action="InsertWeiboServlet" method="post"  enctype="multipart/form-data"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="input">
      <tr>
      ...
      <tr>
        <td height="84">&nbsp;</td>
        <td><textarea id="inputbox" name="weibotext" cols="45" rows="5"></textarea></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td align="right" valign="top"><img src="images/imgupload.png" width="47" height="22"  />
        <input type="file" name ="upfile"/>
         <input name="dosubmit" type="submit" id="dosubmit" value="" style="background:url(images/btn_input.png); border-style:none; width:100px; height:26px; background-repeat:no-repeat;" /></td>
        <td>&nbsp;</td>
      </tr>
    </table></form>
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="menu">
          <tr>
            ...
            <form id="form1" name="form1" method="post" action="FuzzyWeiboServlet">
    ...
    <!-- weibo 结束-->
        ...
        <table border="0" align="center" cellpadding="0" cellspacing="0" id="userlist">
          <tr>
            ...
            <td align="right" class="title"><a href="ChangeUserServlet?change=3">[换一换]</a></td>
          </tr>
