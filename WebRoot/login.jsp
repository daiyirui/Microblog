				...
				<td height="515">
					<center>
						...
						<form action="HomeServlet" method="post"
							onsubmit="return checkForm()" id="Checkform">
								...
								<tr>
									<td height="163">
										<table width="45%" height="161" border="0" cellpadding="5"
											...
											<tr>
											    <td style="color:#F00" colspan="3">密码修改成功，请重新登陆！</td>
											</tr>
											</c:if>
											...
											<tr>
												...
												<td width="742" align="left"><input name="usn"
													type="text" class="input1" id="userid" onblur="" /></td>
											</tr>
											<tr>
											...
											<tr align="left">
												...
												<td align="left" nowrap><input type="checkbox"
													name="keep" value="on" />自动登录 &nbsp;&nbsp;&nbsp;<a
													href="findpassword.jsp">忘记密码</a></td>
											</tr>
										</table>
									</td>
								</tr>
