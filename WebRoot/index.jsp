...
<html>
 ...
 <div>
  ...
  <tr>
    <c:forEach items="${applicationScope.userListListener}" var="users" varStatus="su">
      <td>
      <a href="UserDetailServlet?uid=${users.uid}" target="_blank">
        <img src="${users.upic}" id="${users.uid}" title="${users.uname}" onMouseOver="xianshi(this)" onMouseOut="huifu(this)" />     
      </a>
    </td>
